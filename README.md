# Jhaystack
This is a zero dependency JSON search utility. Jhaystack is in particular built for projects where data structures are not known in advance, data exploration is central, or data is highly generic.
...
Strategy | Description
--- | ---
BITAP   |   This strategy will determine if the term can be found inside of the context within a Levenshtein distance of 2.
